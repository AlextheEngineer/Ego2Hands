...
1. **Download the Ego2Hands dataset**
  ...
  * Use the following download links and put the data in the proper path:
    ...
    **Ego2Hands (eval): ** [subject22-25](https://byu.box.com/s/ys2a83r8iga0tlh7aogesc1g1i49jsur)
    ...
    Move the training data into directory "/data/Ego2Hands/eval/". The "/eval/" folder should contain the sequence folders and their corresponding background folders.
